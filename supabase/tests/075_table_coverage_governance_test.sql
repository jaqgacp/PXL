...
INSERT INTO _coverage_registry (table_name, coverage_class) VALUES
  ...
  ('ref_tax_ledger_control', 'reference-populated'),
  ('ref_filing_artifact', 'reference-populated'),
  ('ref_filing_artifact_kind', 'reference-populated'),
  ('ref_filing_export_column', 'reference-populated'),
  ('filing_artifacts', 'workflow-deferred'),
  ('filing_artifact_lines', 'workflow-deferred'),
  ...
  ('inventory_canonical_form_versions', 'dormant-foundation'),
  ('inventory_correction_graph_versions', 'dormant-foundation'),
  ('inventory_event_effect_ranks', 'dormant-foundation'),
  ...
  ('inventory_valuation_stream_sequences', 'dormant-foundation'),
  ('inventory_valuation_streams', 'dormant-foundation'),

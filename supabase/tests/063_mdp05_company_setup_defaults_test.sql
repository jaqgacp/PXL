...
SELECT is(fn_seed_company_coa('22222222-2222-2222-2222-222222222651'), 43,
  'default template selection seeds the full PH_STANDARD chart of accounts (43 accounts incl. GRNI 2015 and GDNI 1310)');
SELECT is(
...
SELECT is(
  (SELECT count(*)::int FROM chart_of_accounts WHERE company_id='22222222-2222-2222-2222-222222222651'), 43,
...
SELECT is(
  (SELECT count(*)::int FROM chart_of_accounts WHERE company_id='22222222-2222-2222-2222-222222222652'), 43,
...
SELECT is(fn_seed_company_coa('22222222-2222-2222-2222-222222222652'), 43,

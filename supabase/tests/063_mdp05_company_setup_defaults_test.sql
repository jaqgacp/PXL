...
SELECT is(fn_seed_company_coa('22222222-2222-2222-2222-222222222651'), 44,
  'default template selection seeds the full PH_STANDARD chart of accounts (44 accounts incl. GRNI 2015, GDNI 1310 and Percentage Tax Payable 2240)');
SELECT is(
...
SELECT is(
  (SELECT count(*)::int FROM chart_of_accounts WHERE company_id='22222222-2222-2222-2222-222222222651'), 44,
...
SELECT is(
  (SELECT count(*)::int FROM chart_of_accounts WHERE company_id='22222222-2222-2222-2222-222222222652'), 44,
...
SELECT is(fn_seed_company_coa('22222222-2222-2222-2222-222222222652'), 44,

...
This file summarizes tax behavior. The field-level source, BIR/reporting use, and validation gate is controlled by `PXL_TRANSACTION_FIELD_SOURCE_MATRIX.md`.

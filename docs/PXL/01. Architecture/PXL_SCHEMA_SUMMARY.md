...
**Status:** Generated schema snapshot
**Authority:** Tier 1 Generated Reference; migrations and database truth prevail
**Owner / Domain:** Architecture
**Applies To:** Architecture
**Read When:** Schema inspection or migration/object lookup
**Do Not Read For:** Runtime behavior proof without database verification

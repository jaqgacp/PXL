# PXL Sales Invoice Form UX Standard (Superseded)
...
Sales Invoice no longer governs transaction UI. Its source-backed business behavior remains governed by the Sales Invoice functional, field, dimension, tax, GL, inventory, and posting specifications.

...
Field source control: `docs/PXL/04. Transaction Framework/PXL_TRANSACTION_FIELD_SOURCE_MATRIX.md`
...
- `docs/PXL/04. Transaction Framework/PXL_TRANSACTION_FIELD_SOURCE_MATRIX.md` when field-source status, rules, or matrix requirements change
- `docs/PXL/12. UI and UX/PXL_TRANSACTION_WORKSPACE_STANDARD.md` when workspace architecture changes
- `docs/PXL/12. UI and UX/PXL_TRANSACTION_WORKSPACE_PATTERNS.md` when A–E content variation changes
- `docs/PXL/04. Transaction Framework/PXL_TRANSACTION_MATRIX.md` or `docs/PXL/02. Accounting Core/PXL_ACCOUNTING_RULES_MATRIX.md` when transaction behavior changes

...
First validated implementation: Sales Invoice Create/Edit Workspace; UI architecture is governed separately by `docs/PXL/12. UI and UX/PXL_TRANSACTION_WORKSPACE_STANDARD.md`

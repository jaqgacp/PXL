...
Migrations: see `docs/PXL/PXL_SCHEMA_SUMMARY.md` (generated) for the full chain; hosted sync status is tracked in `AI/AI_STATE.md` (verify with `supabase migration list --linked`). As of session 90, hosted is synced through `20260713000015`; local migrations `20260714000001` and `20260714000002` are pending hosted sync. The held-out `20260710000004`/`20260710000005` drafts remain excluded unless explicitly owned and fixed.

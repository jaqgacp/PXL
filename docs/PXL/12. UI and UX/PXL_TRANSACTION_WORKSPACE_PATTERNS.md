...
**Authority:** Tier 1, subordinate to `docs/PXL/12. UI and UX/PXL_TRANSACTION_WORKSPACE_STANDARD.md` for all layout and visual decisions
**Version:** 1.0
...
Any proposed pattern change that affects geometry belongs in `docs/PXL/12. UI and UX/PXL_TRANSACTION_WORKSPACE_STANDARD.md`, not here.

...
**Business variation:** `docs/PXL/12. UI and UX/PXL_TRANSACTION_WORKSPACE_PATTERNS.md`
...
Only source-backed business content varies. `docs/PXL/12. UI and UX/PXL_TRANSACTION_WORKSPACE_PATTERNS.md` defines the permitted variation.
...
- Draft-state ownership follows `docs/PXL/04. Transaction Framework/PXL_TRANSACTION_DRAFT_STATE_STANDARD.md`; field changes are scoped partial updates.

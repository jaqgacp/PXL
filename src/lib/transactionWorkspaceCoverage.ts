...
export const IMPLEMENTED_TRANSACTION_WORKSPACES = [
  ...
  { key: 'receiving-report', transaction: 'Receiving Report / Goods Receipt', module: 'Purchasing/AP', route: '/receiving-reports', page: 'ReceivingReportsPage.tsx', family: 'purchase', pattern: 'B', posting: 'posting', form: 'in-page-mode', view: 'in-page-mode', primaryAdaptation: 'Received quantities, warehouse and source Purchase Order; confirmation posts inventory / Goods Received Not Invoiced and governed cancellation reverses both journal and stock', fieldSourceGate: 'transaction-matrix-only' },

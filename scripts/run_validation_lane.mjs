...
function canonical() {
  ...
  runStep(
    ...
    [
      ...
      'supabase/tests/080_dimension_engine_certification_test.sql',
      'supabase/tests/081_coa_engine_certification_test.sql',
      'supabase/tests/082_posting_engine_p1_infra_test.sql',
      'supabase/tests/083_posting_engine_p2a_sales_resolver_test.sql',
      'supabase/tests/084_posting_engine_p2b_purchasing_resolver_test.sql',
      'supabase/tests/085_posting_engine_p2c_inventory_resolver_test.sql',
      'supabase/tests/086_posting_engine_p2d_banking_payments_resolver_test.sql',
      'supabase/tests/087_posting_engine_p3a_dimension_push_test.sql',
      'supabase/tests/088_posting_engine_p3c_manual_je_control_test.sql',
      'supabase/tests/089_posting_engine_p3d_preview_resolver_test.sql',
      'supabase/tests/090_posting_engine_p4_tax_boundary_test.sql',
      'supabase/tests/091_posting_engine_p5a_surface_closure_test.sql',
      'supabase/tests/092_posting_engine_p51_kernel_guard_test.sql',
      'supabase/tests/093_posting_engine_p51_stage2_test.sql',
      'supabase/tests/094_posting_engine_p51_stage3_batch_a_test.sql',
      'supabase/tests/095_posting_engine_p51_stage4_manual_journal_test.sql',
      'supabase/tests/096_posting_engine_p51_stage5_inventory_test.sql',
      'supabase/tests/097_posting_engine_p51_stage6_treasury_test.sql',
      'supabase/tests/098_posting_engine_p51_stage7_assets_schedules_test.sql',
      'supabase/tests/099_posting_engine_p51_stage8_system_generated_test.sql',
      'supabase/tests/100_posting_engine_p51_stage9_commerce_test.sql',
      'supabase/tests/101_posting_engine_p51_ready_to_arm_test.sql',
      'supabase/tests/102_posting_engine_p52_enforcement_security_test.sql',
    ],
  );
}

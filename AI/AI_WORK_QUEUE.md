...
AIQ-008 (continue): rebase the VAT review views and 2550 generators on `tax_detail_entries` (PXL-AUD-014 final step), or PXL-DA-017 dimension propagation per DEC-011. Summary docs AIQ-006–007 follow when audit work pauses.

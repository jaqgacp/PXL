...
AIQ-008 (continue): build the snapshot reader/drilldown UI to close PXL-DA-015 implementation (all six snapshot families exist through `20260703000009` — do not redo them), or PXL-DA-017 dimension propagation per DEC-011. Summary docs AIQ-006–007 follow when audit work pauses.

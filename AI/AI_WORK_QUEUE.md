...
AIQ-008 (continue): extend `report_snapshots` to the books journal exports under PXL-DA-015, or build the snapshot reader/drilldown UI, or PXL-DA-017 dimension propagation per DEC-011 if choosing the next unblocked accounting architecture task. Do not redo VAT return snapshots (`20260703000004`), Form 2307 issued snapshots (`20260703000005`), SLSP/RELIEF export snapshots (`20260703000006`), SAWT/QAP export snapshots (`20260703000007`), or CAS DAT export snapshots (`20260703000008`). Summary docs AIQ-006–007 follow when audit work pauses.

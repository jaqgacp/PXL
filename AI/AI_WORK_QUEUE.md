...
| P5A Final SI dense template | Final 2026-07-13 brief plus compact-header refinement: company-accent short header + 3% tint, one-line state/workflow strip, exactly four compact information cards, no right rail, no-overflow one-line tabs including Related Party, Operations/Accounting/Audit/All line profiles + chooser + inline expansion + totals, expanded GL/Tax/Validation/Approval/Audit/Related Party/Attachments/Notes/System tabs, company appearance master-data migration/UI. Build/lint/diff-check green. | Done (sessions 68-69) |

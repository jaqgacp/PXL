...
AIQ-008 (continue): PXL-DA-015 and PXL-DA-017 are closed — do not redo them. Next: PXL-DA-011 status-aware immutability across all transactional tables, or PXL-DA-001 server-side GL preview RPC, or the small PXL-AUD-029 AppShell feature-gating fix. Summary docs AIQ-006–007 follow when audit work pauses.

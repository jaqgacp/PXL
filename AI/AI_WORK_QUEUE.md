...
Standing (authoritative = Findings Status Index): **59 Retested Passed / 8 In Progress / 5 Open (72), no Criticals open.** Session 86 closed **PXL-AUD-016** and **PXL-AUD-013 + PXL-DA-014** (`20260713000013`, test 040), committed as `38ac28a`. Session 87 closed **PXL-DA-016** with governed `transaction_events` lifecycle evidence (`20260713000014`, test 041, 14 assertions). Sessions 88-89 closed **PXL-AUD-043** with cash-purchase EWT (`20260713000015`, test 042, 10 assertions) and advance/down-payment withholding (`20260714000001`, test 043, 13 assertions); trusted pgTAP is **774/774 across 42 files**. Hosted Supabase is synced through `20260713000015`; `20260714000001` is pending hosted sync.

Next unblocked core work: **PXL-AUD-040** (per-month 2307 breakdown), then **PXL-AUD-046**/**047** (cash-sale total + 2307-claim correctness), and the remaining In-Progress test/coverage/report items (AUD-008/009/010, DA-013/018/020, AUD-044/045/049/050). Close follow-ups deferred to backlog: later application of posted advances/down-payments to subsequently issued SI/VB, a Period-Close UI over `fn_close_fiscal_year`, an optional Income-Summary close, and configurable FS-line mappings.
...
Do not redo AUD-002, AUD-006, AUD-014, AUD-034, AUD-035, AUD-036, AUD-037, AUD-038, AUD-039, AUD-041, AUD-042, AUD-043, AUD-048, AUD-051, DA-001, DA-002, DA-004, DA-005, DA-006, DA-007, DA-008, DA-009, DA-010, or DA-019. The unowned ATC/CAS work (`20260710000004/00005` + test 027) is confirmed broken (breaks test 021; own test fails 15/30), stays untracked and off hosted per the user's 2026-07-11 decision, and must be held out of resets/tests/pushes/docs-gate runs until explicitly owned and fixed.

...
AIQ-008 (continue): PXL-DA-015 is closed (six snapshot families + reader UI — do not redo them). Next: PXL-DA-017 dimension propagation to JE lines per DEC-011, or the small PXL-AUD-029 AppShell feature-gating fix. Summary docs AIQ-006–007 follow when audit work pauses.

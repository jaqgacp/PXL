...
AIQ-008 (continue): PXL-DA-011, PXL-AUD-005, PXL-DA-015, PXL-DA-017, PXL-AUD-029, and PXL-AUD-030 are closed — do not redo them. Next: PXL-DA-001 server-side GL preview RPC, PXL-DA-002 drilldown contracts, or PXL-DA-004 posting-engine consolidation. Regenerate `src/lib/database.types.ts` (`npm run gen:types`) after every migration; backfills on non-draft rows need `session_replication_role = replica`. Summary docs AIQ-006–007 follow when audit work pauses.
